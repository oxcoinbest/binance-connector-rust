...
use binance_sdk::derivatives_trading_usds_futures::{
    DerivativesTradingUsdsFuturesWsStreams, websocket_streams::LiquidationOrderStreamsParams,
};
...
async fn main() -> Result<()> {
    ...
    let params = LiquidationOrderStreamsParams::builder("btcusdt".to_string()).build()?;
