...
use binance_sdk::derivatives_trading_coin_futures::{
    DerivativesTradingCoinFuturesWsStreams, websocket_streams::IndividualSymbolTickerStreamsParams,
};
...
async fn main() -> Result<()> {
    ...
    let params = IndividualSymbolTickerStreamsParams::builder("btcusdt".to_string()).build()?;
